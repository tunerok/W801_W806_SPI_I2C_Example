...
Date                   :=27/01/2023
CDKPath                :=E:/C-Sky/CDK
ToolchainPath          :=E:/C-Sky/CDKRepo/Toolchain/CKV2ElfMinilib/V3.10.29/R/
...
IncludePackagePath     :=
IncludeCPath           := $(IncludeSwitch)E:/C-Sky/CDK/CSKY/MinGW/csky-abiv2-elf-toolchain/csky-elfabiv2/include $(IncludeSwitch). $(IncludeSwitch)../../../../../../../app/inc $(IncludeSwitch)../../../../../../../include $(IncludeSwitch)../../../../../../../include/ST7789 $(IncludeSwitch)../../../../../../../include/arch/xt804 $(IncludeSwitch)../../../../../../../include/arch/xt804/csi_core $(IncludeSwitch)../../../../../../../include/arch/xt804/csi_dsp $(IncludeSwitch)../../../../../../../include/driver $(IncludeSwitch)../../../../../../../platform/component/FreeRTOS/include $(IncludeSwitch)../../../../../../../platform/component/FreeRTOS/portable/xt804  
IncludeAPath           := $(IncludeSwitch)E:/C-Sky/CDK/CSKY/csi/csi_core/csi_cdk/ $(IncludeSwitch)E:/C-Sky/CDK/CSKY/csi/csi_core/include/ $(IncludeSwitch)E:/C-Sky/CDK/CSKY/csi/csi_driver/include/ $(IncludeSwitch). $(IncludeSwitch)../../../../../../../include $(IncludeSwitch)../../../../../../../include/ST7789 $(IncludeSwitch)../../../../../../../include/arch/xt804 $(IncludeSwitch)../../../../../../../include/arch/xt804/csi_core $(IncludeSwitch)../../../../../../../include/arch/xt804/csi_dsp $(IncludeSwitch)../../../../../../../platform/component/FreeRTOS/include  
...
CXXFLAGS := -mcpu=ck804ef  -mhard-float   $(PreprocessorSwitch)GCC_COMPILE=1  $(PreprocessorSwitch)TLS_CONFIG_CPU_XT804=1   -O3  -g3  -Wall  -ffunction-sections -fdata-sections -c 
CFLAGS   := -mcpu=ck804ef  -mhard-float   $(PreprocessorSwitch)GCC_COMPILE=1  $(PreprocessorSwitch)TLS_CONFIG_CPU_XT804=1   -O3  -g3  -Wall  -ffunction-sections -fdata-sections -c 
...
$(IntermediateDirectory)/ST7789_fonts$(ObjectSuffix): ../../../../../../../include/ST7789/fonts.c  
	$(CC) $(SourceSwitch) ../../../../../../../include/ST7789/fonts.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/ST7789_fonts$(ObjectSuffix) -MF$(IntermediateDirectory)/ST7789_fonts$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/ST7789_fonts$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/ST7789_fonts$(PreprocessSuffix): ../../../../../../../include/ST7789/fonts.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/ST7789_fonts$(PreprocessSuffix) ../../../../../../../include/ST7789/fonts.c

$(IntermediateDirectory)/ST7789_st7789$(ObjectSuffix): ../../../../../../../include/ST7789/st7789.c  
	$(CC) $(SourceSwitch) ../../../../../../../include/ST7789/st7789.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/ST7789_st7789$(ObjectSuffix) -MF$(IntermediateDirectory)/ST7789_st7789$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/ST7789_st7789$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/ST7789_st7789$(PreprocessSuffix): ../../../../../../../include/ST7789/st7789.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/ST7789_st7789$(PreprocessSuffix) ../../../../../../../include/ST7789/st7789.c
...
$(IntermediateDirectory)/src_my_spi$(ObjectSuffix): ../../../../../../../app/src/my_spi.c  
	$(CC) $(SourceSwitch) ../../../../../../../app/src/my_spi.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_my_spi$(ObjectSuffix) -MF$(IntermediateDirectory)/src_my_spi$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_my_spi$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_my_spi$(PreprocessSuffix): ../../../../../../../app/src/my_spi.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_my_spi$(PreprocessSuffix) ../../../../../../../app/src/my_spi.c

$(IntermediateDirectory)/src_draw_math$(ObjectSuffix): ../../../../../../../app/src/draw_math.c  
	$(CC) $(SourceSwitch) ../../../../../../../app/src/draw_math.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_draw_math$(ObjectSuffix) -MF$(IntermediateDirectory)/src_draw_math$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_draw_math$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_draw_math$(PreprocessSuffix): ../../../../../../../app/src/draw_math.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_draw_math$(PreprocessSuffix) ../../../../../../../app/src/draw_math.c

$(IntermediateDirectory)/auto_dl_auto_dl$(ObjectSuffix): ../../../../../../../platform/component/auto_dl/auto_dl.c  
	$(CC) $(SourceSwitch) ../../../../../../../platform/component/auto_dl/auto_dl.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/auto_dl_auto_dl$(ObjectSuffix) -MF$(IntermediateDirectory)/auto_dl_auto_dl$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/auto_dl_auto_dl$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/auto_dl_auto_dl$(PreprocessSuffix): ../../../../../../../platform/component/auto_dl/auto_dl.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/auto_dl_auto_dl$(PreprocessSuffix) ../../../../../../../platform/component/auto_dl/auto_dl.c
